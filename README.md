...
- 오늘 알게된 내용을 정리해두는 저장소  
- 아주 기초적인 것부터 심화까지 모두 기록합니다.
- 찾기 쉽도록 저장하기  
- 단순히 붙여넣기나 커밋용으로는 글을 작성하지 않습니다.
- 좀더 정리된 글을 블로그에 작성할 기획입니다. (추후 블로그 링크추가)

## 복습
- 1, 4, 7 ,14 ,28 복습
- 1일전, 3일전, 6일전, 13일전, 27일전 내용을 복습합니다.
- 요일별이 아닌 내용 복습은 커밋 history를 이용합니다.
...
- [개발자가 연봉 1억을 넘길 수 있는 방법](https://okky.kr/articles/1433350)
- [체대 출신 개발자의 2018년 회고](https://ryan-han.com/post/memoirs/memoirs2018/)

### Git

- [체대출신 개발자 TIL](https://github.com/Integerous/TIL)
...
- [책 스터디방법 - 자바봄이 이펙티브 자바를 읽는 방법](https://javabom.tistory.com/70)
